...
chmod +x main_pretrain.py
chmod +x preprocess_core50.py
chmod +x compare_hyperParams.py
chmod +x compare_multiple.py 
chmod +x compare_all.py
chmod +x main_generative.py
chmod +x compare_replay.py
chmod +x compare_s.py
